...
module.exports = async function (fastify, opts) {
  ...
  // the response body should include the following fields: user.email, user.username, and user.token
  // example response:
  // {
  //   user: {
  ...
  // obtained by using the "hashString" utility method sending the user.password as a function parameter, a record should be inserted
  // into the "user" table
